...
func insert(organizationId string, queryBuilder *QueryBuilder, queryArguments *cypressutils.CypressHashMap) (twrapper *cypressutils.TransactionWrapper) {
...
func batchInsert(organizationId string, queryBuilder *QueryBuilder, queryArgsList *cypressutils.CypressArrayList) (twrapper *cypressutils.TransactionWrapper) {
...
func getPrimaryKeyColumns(organizationId string, dbConn *sql.DB, tableName string) (*cypressutils.CypressArrayList, error) {
...
func RawQuery(organizationId string, query string, queryArguments *cypressutils.CypressHashMap) (twrapper *cypressutils.TransactionWrapper) {
	twrapper = cypressutils.NewTransactionWrapper(false)
...
func selectData(organizationId string, query string, queryArguments *cypressutils.CypressHashMap) (twrapper *cypressutils.TransactionWrapper) {
	twrapper = cypressutils.NewTransactionWrapper()
...
func update(organizationId string, queryBuilder *QueryBuilder, queryArguments *cypressutils.CypressHashMap) (twrapper *cypressutils.TransactionWrapper) {
	twrapper = cypressutils.NewTransactionWrapper()
...
func deleteData(organizationId string, queryBuilder *QueryBuilder, queryArguments *cypressutils.CypressHashMap) (twrapper *cypressutils.TransactionWrapper) {
	twrapper = cypressutils.NewTransactionWrapper()
...
func validateQueryArguments(query string, queryArguments *cypressutils.CypressHashMap) (*cypressutils.Set, error) {
	allQueryVariables := cypressutils.NewSet()
...
func ParseSQLRawBytesToType(value []byte, columnName string, columnType *sql.ColumnType, hashMap *cypressutils.CypressHashMap) {
	...
	case "INT", "BIGINT", "INT4":
		{
			if value == nil {
				...
				hashMap.PutValue(columnName, miscellaneous.BytesToInt64(value))
			}
		}
