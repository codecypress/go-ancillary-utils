...
func Insert(organizationId, tableName string, recordHashMap *cypressutils.CypressHashMap) (twrapper *cypressutils.TransactionWrapper) {
...
func InsertFromMap(organizationId, tableName string, recordHashMap map[string]interface{}) (twrapper *cypressutils.TransactionWrapper) {
	queryArguments := cypressutils.NewMap()
...
func InsertOnDuplicate(organizationId, tableName string, recordHashMap *cypressutils.CypressHashMap, onDuplicateColumns []string) (twrapper *cypressutils.TransactionWrapper) {
	queryArguments := cypressutils.NewMap()
...
func InsertFromMapOnDuplicate(organizationId, tableName string, onDuplicateColumns []string, recordHashMap map[string]interface{}) (twrapper *cypressutils.TransactionWrapper) {
	queryArguments := cypressutils.NewMap()
...
func BatchInsert(organizationId, tableName string, queryArgsList *cypressutils.CypressArrayList) (twrapper *cypressutils.TransactionWrapper) {
	queryBuilder := NewQueryBuilder()
...
func GetPrimaryKeyColumns(organizationId string, tableName string) (twrapper *cypressutils.TransactionWrapper) {
...
func Update(organizationId, tableName string, updateSet *cypressutils.CypressHashMap, filterPredicate *FilterPredicate,
	queryArguments *cypressutils.CypressHashMap, selectPreUpdate bool, pagePageSize []int) (twrapper *cypressutils.TransactionWrapper) {
	defer func() {
		if r := recover(); r != nil {
			fmt.Println(r)
			debug.PrintStack()
	...
	if selectPreUpdate {
		...
		primaryKeyColsList := primKeysWrapper.Data.(*cypressutils.CypressArrayList)
...
func Delete(organizationId, tableName string, filterPredicate *FilterPredicate, queryArguments *cypressutils.CypressHashMap) (twrapper *cypressutils.TransactionWrapper) {
	twrapper = cypressutils.NewTransactionWrapper()
	if queryArguments == nil {
		queryArguments = cypressutils.NewMap()
	}
...
func JoinSelectQuery(organizationId string, queryBuilder *QueryBuilder, queryArguments *cypressutils.CypressHashMap, pagePageSize []int) (twrapper *cypressutils.TransactionWrapper) {
	defer func() {
		if r := recover(); r != nil {
			fmt.Println(r)
			debug.PrintStack()
...
func JoinCountQuery(organizationId string, queryBuilder *QueryBuilder, queryArguments *cypressutils.CypressHashMap) int {
...
func JoinExistsQuery(organizationId string, queryBuilder *QueryBuilder, queryArguments *cypressutils.CypressHashMap) bool {
...
func SelectWithQueryBuilder(organizationId string, queryBuilder *QueryBuilder, queryArguments *cypressutils.CypressHashMap, pagePageSize []int) (twrapper *cypressutils.TransactionWrapper) {
	defer func() {
		if r := recover(); r != nil {
			fmt.Println(r)
			debug.PrintStack()
...
func Count(organizationId string, queryBuilder *QueryBuilder, queryArguments *cypressutils.CypressHashMap) int {
	countQueryBuilder := NewQueryBuilder().Select().SelectColumn("COUNT(*) AS count")
...
func Exists(organizationId string, queryBuilder *QueryBuilder, queryArguments *cypressutils.CypressHashMap) bool {
	countQueryBuilder := NewQueryBuilder().Select().SelectColumn("1")
	countQueryBuilder.FromTable(queryBuilder.GetTableName())
	countQueryBuilder.WhereStr(queryBuilder.GetWhereClause())
...
func Select(organizationId, tableName, columns string, pagePageSize []int) (twrapper *cypressutils.TransactionWrapper) {
	defer func() {
		if r := recover(); r != nil {
...
func SelectOrderBy(organizationId, tableName, columns, columnOrderBy string, pagePageSize []int) (twrapper *cypressutils.TransactionWrapper) {
	defer func() {
		if r := recover(); r != nil {
			fmt.Println(r)
			debug.PrintStack()
...
func SelectGroupBy(organizationId, tableName, columns, groupByColumns string, havingPredicate *FilterPredicate, queryArguments *cypressutils.CypressHashMap, pagePageSize []int) (twrapper *cypressutils.TransactionWrapper) {
	defer func() {
		if r := recover(); r != nil {
			fmt.Println(r)
			debug.PrintStack()
...
func SelectGroupByOrderBy(organizationId, tableName, columns, groupByColumns string, havingPredicate *FilterPredicate, columnOrderBy string, queryArguments *cypressutils.CypressHashMap, pagePageSize []int) (twrapper *cypressutils.TransactionWrapper) {
	defer func() {
		if r := recover(); r != nil {
			fmt.Println(r)
			debug.PrintStack()
...
func CountGroupBy(organizationId, tableName, groupByColumns string, havingPredicate *FilterPredicate, queryArguments *cypressutils.CypressHashMap) int {
	if queryArguments == nil {
		queryArguments = cypressutils.NewMap()
	}
	queryArguments.SetTableName(tableName)
...
func SelectWhere(organizationId, tableName, columns string, filterPredicate *FilterPredicate, queryArguments *cypressutils.CypressHashMap, pagePageSize []int) (twrapper *cypressutils.TransactionWrapper) {
	defer func() {
		if r := recover(); r != nil {
			fmt.Println(r)
			debug.PrintStack()
...
func CountWhere(organizationId, tableName string, filterPredicate *FilterPredicate, queryArguments *cypressutils.CypressHashMap) int {
	if queryArguments == nil {
		queryArguments = cypressutils.NewMap()
	}
	queryArguments.SetTableName(tableName)
...
func SelectWhereOrderBy(organizationId, tableName, columns string,
	...
	pagePageSize []int) (twrapper *cypressutils.TransactionWrapper) {
...
func CountWhereGroupBy(organizationId, tableName string, wherePredicate *FilterPredicate, groupByColumns string, havingPredicate *FilterPredicate, queryArguments *cypressutils.CypressHashMap) int {
	if queryArguments == nil {
		queryArguments = cypressutils.NewMap()
	}
	queryArguments.SetTableName(tableName)
...
func paginate(tableName string, records interface{}, totalCount, page, pageSize int) *cypressutils.PageableWrapper {
	wrapper := cypressutils.NewPageableWrapper()
