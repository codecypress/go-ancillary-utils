...
func GenerateFilterString(filterStatement string) (string, *CypressHashMap, *Set, error) {
...
func (fPredicate *formPredicate) getFilterPredicate() (string, *CypressHashMap, *Set) {
